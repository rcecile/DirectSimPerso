...
; current plotting device.
   mydevice = !D.NAME
   SET_PLOT, 'PS'
   DEVICE, FILENAME='/sps/lsst/dev/rcecile/Fig/plot_ps_wosc'+proj+'.eps', /PORTRAIT,/COLOR,XSIZE=8.8,YSIZE=5.5,FONT_SIZE=4
endif
...
for iz=0,nz-1 do begin
   ...
   for isuff=0,n_elements(nsuff)-1 do begin
      ...
      nsim=0
      t  = dir + 'PS'+proj+nx[iz]+'_z'+namez[iz]+suff+'_wngal.txt' 
      print,t
      check = FILE_TEST(t)
