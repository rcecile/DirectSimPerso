...
; current plotting device.
   mydevice = !D.NAME
   SET_PLOT, 'PS'
   DEVICE, FILENAME='/sps/lsst/users/rcecile/Fig/plot_psfit.eps', /PORTRAIT,/COLOR,XSIZE=8.8,YSIZE=5.5,FONT_SIZE=4
endif else window,0


plot,[0.5,19.5],[141.5,158.5],/nodata,/xs,/ys,ytit='BAO scale [Mpc]',xticknam=replicate(" ",20),xma=[7.5,.5],yma=[.75,.5];,yticklen=1
for iz=0,2 do begin
   print,'iz = ', namez[iz]
   for ierr=0,n-1 do begin
      ...
      oplot,[idx,idx],[(pfitw.(0))[0]-(pfitw.(2))[0],(pfitw.(0))[0]+(pfitw.(1))[0]],th=10,col=lcol[ierr]
      oplot,[idx,idx],[(pfitw.(0))[0],(pfitw.(0))[0]],psym=4,th=2
   endfor
endfor

oplot,[0,30],[s,s],li=2,th=3
;xyouts, 1,139.6,'grids @ z=0.5',charsize=2
;xyouts, 8,139.6,'grids @ z=0.9',charsize=2
;xyouts,15,139.6,'grids @ z=1.5',charsize=2
legend,'z = '+namez[0],charsize=2,/bottom,/left,/box
legend,'z = '+namez[1],charsize=2,/bottom,/center,/box
legend,'z = '+namez[2],charsize=2,/bottom,/right,/box

legend,lerr,li=0,col=lcol,box=1,/fill,/left,/top,charsize=1.5,th=3
