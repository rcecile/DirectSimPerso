...
;    legend,err,col=mycol,box=1,psym=0,/fill,/left,/top,charsize=1.5,th=2
   ...
   if(id eq 1) then legend,err[0],col=mycol[0],box=1,psym=0,/fill,/left,/top,charsize=1.5,th=3
   if(id eq 1) then legend,err[1],col=mycol[1],box=1,psym=0,/fill,/right,/top,charsize=1.5,th=3
   if(id eq 2) then legend,err[2],col=mycol[2],box=1,psym=0,/fill,/left,/top,charsize=1.5,th=3
   if(id eq 2) then legend,err[3],col=mycol[3],box=1,psym=0,/fill,/right,/top,charsize=1.5,th=3
