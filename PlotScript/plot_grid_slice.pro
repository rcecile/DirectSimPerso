...
; current plotting device.
   mydevice = !D.NAME
   SET_PLOT, 'PS'
   DEVICE, FILENAME='/sps/lsst/users/rcecile/Fig/plot_grid_slice'+strtrim(iz,2)+'.eps', /PORTRAIT,/COLOR,XSIZE=8.8,YSIZE=7.5,FONT_SIZE=4
endif else window,iz+1,XSIZE=880,YSIZE=600

g1 = mrdfits(dir+"grids_superSN5_"+strtrim(nx[iz],2)+"_z"+namez[iz]+"_5cubes.fits",1,h)
g2 = mrdfits(dir+"grids_superSN5_"+strtrim(nx[iz],2)+"_z"+namez[iz]+nsuff[4]+"_5cubes.fits",1,h)
;g1 = mrdfits(dir+"grids_lfZuccaAllFalse_"+strtrim(nx[iz],2)+"_z"+namez[iz]+"_5cubes.fits",1,h)
;g2 = mrdfits(dir+"grids_lfZuccaAllFalse_"+strtrim(nx[iz],2)+"_z"+namez[iz]+nsuff[4]+"_5cubes.fits",1,h)
