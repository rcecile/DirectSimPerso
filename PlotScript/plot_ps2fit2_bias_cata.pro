PRO plot_ps2fit2_bias_cata,saveplot
...
datasuff=['','_noBias','_noCata']
lerr=['photoZ','photoZ BDT 80%']
ldata=['noBAO with all galaxies','noBAO without bias','noBAO without catastrophic galaxy']
ltyp=[0,2,1]
...
; current plotting device.
   mydevice = !D.NAME
   SET_PLOT, 'PS'
   DEVICE, FILENAME='/sps/lsst/dev/rcecile/Fig/plot_ps2fit_CataBias.eps', /PORTRAIT,/COLOR,XSIZE=8.8,YSIZE=6.6,FONT_SIZE=4
endif 
...
for iz=0,1  do begin
   ...
   for ierr=0,1 do begin
      ...
      for id=0,2 do begin
         ...
         xyouts,0.025+0.008*(iz*2+ierr),3-iz*2-ierr+1.2,'z='+namez[iz]+', '+lerr[ierr],charsize=1.7
      endfor
   endfor
endfor
legend,ldata,line=ltyp,box=1,/fill,/right,/top,charsize=1.5
