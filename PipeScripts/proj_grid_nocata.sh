...
# for noBAO case, just change the dir & dirg paths & nCase
 ...
 function do_big_err {
     echo "==========================================================================="
     echo "==========================================================================="
     command="${code1}grid_data -C $4 -s ${dirsf}SelFunc_gaussmean -R -P $1,$1,$3,$2,$cell,$cell -z ZG,ZS -O ${dirg}grid_G2$6_$1_z$2_G$5_nocata.fits"
     echo "I launch " $command
     $command
}
 ...
 function do_big_perr {
     echo "==========================================================================="
     echo "==========================================================================="
     command="${code1}grid_data -C $4 -s ${dirsf}SelFunc_photzmean -R -P $1,$1,$3,$2,$cell,$cell -z ZP,ZS -O ${dirg}grid_G2$6_$1_z$2_errP_nocata.fits"
     $command

     command="${code1}grid_data -C $5 -s ${dirsf}SelFunc_poddsmean -R -P $1,$1,$3,$2,$cell,$cell -z ZP,ZS -O ${dirg}grid_G2$6_$1_z$2_errPpodds_nocata.fits"
     $command
}
