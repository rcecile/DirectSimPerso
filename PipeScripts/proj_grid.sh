...
# for noBAO case, just change the dir & dirg paths & nCase
 ...
 function do_big_base {
     echo "==========================================================================="
     echo "==========================================================================="
     command="${code1}grid_data -C $4 -s ${dirg}SelFunc_G2$5_specmean -P $1,$1,$3,$2,$cell -z ZS,ZS -O ${dirg}grid$5_$1_z$2.fits"
 ...
 function do_big_err {
     echo "==========================================================================="
     echo "==========================================================================="
     command="${code1}grid_data -C $4 -s ${dirg}SelFunc_G2$6_gaussmean -R -P $1,$1,$3,$2,$cell -z ZG,ZS -O ${dirg}grid$6_$1_z$2_G$5.fits"
     echo "I launch " $command
     $command
}
 ...
 function do_big_perr {
     echo "==========================================================================="
     echo "==========================================================================="
     command="${code1}grid_data -C $4 -s ${dirg}SelFunc_G2$6_photzmean -R -P $1,$1,$3,$2,$cell -z ZP,ZS -O ${dirg}grid$6_$1_z$2_errP.fits"
     echo "I launch " $command
     $command

     command="${code1}grid_data -C $5 -s ${dirg}SelFunc_G2$6_poddsmean -R -P $1,$1,$3,$2,$cell -z ZP,ZS -O ${dirg}grid$6_$1_z$2_errPodds.fits"
     echo "I launch " $command
     $command
}
