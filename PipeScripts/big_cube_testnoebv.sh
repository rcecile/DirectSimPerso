...
#     command="${code0}cmvginit3d -o ${dir}simu -u 0.7,0.3,0.05,0.7,-1.,0.,9.06581172724113E-05 -8 0.8154,-8. -G 2 -s 1000,0.001,0.5 -x $1,$3 -y $1,$3 -z $2,$3 -D $4 -O 2,2"
     command="${code0}cmvginit3d -o ${dir}simuMini -U 15 -G 1 -s 1000,0.001,0.5 -x $1,$3 -y $1,$3 -z $2,$3 -D $4 -O 2,2"
 ...
 function do_big_no {
     ...
     command="${code0}cmvginit3d -o ${dirn}simu$5 -U 15 -G 1 -s 1000,0.001,0.5 -x $1,$3 -y $1,$3 -z $2,$3 -D $4 -O 2,2 -L -a"
