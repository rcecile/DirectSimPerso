...
class Cat2Grid
{
 public:
  ...
  inline void SetGrids(vector<ProjGrid>& vgrids) { vgrids_=vgrids; }   
 ...
 protected:
  ...
  vector<sa_size_t> ng_;      /**< number of gals inside grid               */
  vector<r_8> ngw_;           /**< number of gals inside weighted grid      */
  vector<sa_size_t> ngout_;   /**< number of gals outside grid              */ 
